...
export default function ContactForm() {
  ...
  return (
    <div className="bg-fourthly lg:bg-white w-full grid grid-cols-1 lg:grid-cols-2 md:py-6">
      <div className=" md:border flex flex-col  gap-6 justify-center py-8 lg:bg-white md:px-12  ">
