...
export default function WhatsappWidget() {
  ...
  // Hide widget on any route starting with "/oniichan"
  if (pathname.startsWith("/oniichan")) {
    return null;
  }
  ...
  return (
    <a
      ...
      className="fixed bottom-6 right-12 flex items-center gap-3 px-4 transition-transform transform hover:scale-105"
    >
